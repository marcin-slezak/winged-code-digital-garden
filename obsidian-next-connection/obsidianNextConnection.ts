import {getObsidianFilesFlat, getFileContent, PAGES_FILES_EXTENSIONS, MEDIA_FILES_EXTENSIONS} from './files'
...
export const obsidianNextConnection = ({vaultPath, assetPath, urlPagesPrefix}: ObsidianNextConnectionProps) => {
    ...
    return {getNextPaths, getFilesFlat, getFileBySlug, getFileContentAsHtml, prepareMediaFiles}
}
